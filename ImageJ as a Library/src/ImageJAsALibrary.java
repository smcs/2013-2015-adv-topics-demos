...
public class ImageJAsALibrary {
	...
	public static void main(String[] args) {
		/*
		 * An ImagePlus is an object that represents the loaded image. IJ is the
		 * ImageJ application.
		 */
		ImagePlus image = IJ.openImage("images/A.png");

		/*
		 * display the image we're working with in its own window -- this also
		 * puts ImageJ's focus on this image, so that subsequent commands will
		 * run on this image.
		 */
		image.show();
		...
		/*
		 * convert the current image to 8-bit -- calling the command by its
		 * exact name in the menu
		 */
		IJ.run("8-bit");
	}
